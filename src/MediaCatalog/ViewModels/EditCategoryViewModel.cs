...
public partial class EditCategoryViewModel : ViewModelBase, IDialogParticipant
{
    ...
    /// </remarks>
    public EditCategoryViewModel(CategoryViewModel category, ICategoryService categoryService,
    ...
    private async Task SaveAsync()
    {
        ...
        else
        {
            ...
            await _dialogService.ShowOverlayDialogAsync<DialogResult>("Error",
                "An error occurred while saving the category.", DialogCommands.Ok);
        }
    }
