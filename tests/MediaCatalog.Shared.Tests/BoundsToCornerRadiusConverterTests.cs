...
using MediaCatalog.Shared.Converters;
using Xunit;

namespace MediaCatalog.Shared.Tests;
...
public class BoundsToCornerRadiusConverterTests
{
    ...
    public void Convert_WithValidRect_ReturnsCorrectCornerRadius(double x, double y, double width, double height,
