...
namespace MediaCatalog.Tests.ViewModelTests;
...
public class ManageToDoItemsViewModelTest : TestBase
{
    ...
    public async Task ManageToDoItemsViewModel_Constructor_InitializesCorrectly()
    {
        ...
        _testOutputHelper.WriteLine(
            $"Filter: '{vm.FilterString ?? "null"}', Show completed: {vm.ShowAlsoCompletedItems}");
        _testOutputHelper.WriteLine(
            $"Sort1: {vm.SortExpression1}, Sort2: {vm.SortExpression2}, Sort3: {vm.SortExpression3}");
